...
<html lang="en">
                    ...
                    fetch("http://localhost:3030/login", {
                        ...
                        .catch(error => {
                            ...
                            if (error.response && error.response.status === 422) {
                                ...
                                swal("Gagal!", "Masukan email dan password yang didaftarkan", "error");
                            }
                        });
                }
            }))
    ...
    <body x-data="data" class="bg-blue">
        <div class="container">
                ...
                <div class="col">
                    <div class="card-kiri" style="width: 40rem;">
                        ...
                        <div class="card-body" style="text-align: center">
                            <h1 class="card-title-kiri" style="margin-top: 80px">Masuk Ke Aplikasi
                                <span style="color: rgb(23, 177, 224)">SIPUS</span></h1>
                            <p class="card-text-kiri" style="font-size: 15px">Masuk ke aplikasi SIPUS untuk
                                mengecek dan melihat daftar buku yang tersedia di perpustakaan SMAN 1 KOTA BOGOR</p>
                        </div>
                        <img
                ...
                <div class="col-md-auto">
                    <div class="login-start">
                        <div class="card" style="width: 20rem;">
                            <div class="card-body">
                                <h5 class="card-text">Selamat Datang di
                                    <span style="color:rgb(23, 177, 224) ">SIPUS</span>
                                </h5>
